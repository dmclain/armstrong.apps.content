...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_content', (
            ...
            ('access', self.gf('armstrong.core.arm_access.fields.AccessField')(to=orm['arm_access.AccessObject'], unique=True, null=True, blank=True)),
    ...
    models = {
        ...
        'content.content': {
            ...
            'access': ('armstrong.core.arm_access.fields.AccessField', [], {'to': "orm['arm_access.AccessObject']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
